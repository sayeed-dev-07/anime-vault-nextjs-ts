...
const Spinner = () => {
  return (
    <StyledWrapper>
      <svg aria-label="loader being flipped clockwise and circled by three white curves fading in and out" role="img"  width="32px" height='20px' viewBox="0 0 56 56" className="loader">
